...
2. プロジェクト紹介
    ...
    7. [体験型ARアートイベント](#2-7-体験型arアートイベント) <- 一番注力して開発しました
    8. [多人数参加型アート作成アプリ](#2-8-多人数参加型アート作成アプリ)
...
---
# 2-8. [多人数参加型アート作成アプリ](https://github.com/KSF2024/Documents/blob/main/%E3%82%A2%E3%83%97%E3%83%AA%E4%BC%81%E7%94%BB%E6%9B%B8.md)
![bg left:30% h:700](image-9.png)
- プロジェクト名: 「HANABINOVATION」
- 担当: プロジェクトマネージャー, 企画, 設計, バックエンド, フロントエンド
- 制作時期: 3年次前期
- 使用予定技術: Typescript, React, MUI, Vite, AWS
- プロジェクト説明:
    - 2024年度河原学園大学園祭において、ITイノベーション科3年より公開予定のWebアプリ
    - 現在設計/開発段階
...
- 多人数参加型アート作成アプリ「[HANABINOVATION](https://github.com/KSF2024/Documents)」(企画書・設計書)
